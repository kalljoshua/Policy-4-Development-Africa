...
@section('title')
    <title>Policy Sub-Categories</title>
@endsection
@section('content')
...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">All Policy Sub-Categories</li>
    </ol>
  </section>
      ...
      <div class="col-xs-12">
        <div class="box">
            <div class="box-header">
              <h3 class="box-title">All available Policy Sub-Categories</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>{{$sub_category->policies->count()}}</td>
                  <td class="text-left">
