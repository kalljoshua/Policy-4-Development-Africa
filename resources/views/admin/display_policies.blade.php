      ...
      <div class="col-xs-12">
        <div class="box">
            <div class="box-header">
              <h3 class="box-title">Policy Listings</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
            ...
            @foreach($policies as $company)
                <tr>
                    ...
                    <td>{{$company->file}}</td>
                    <td> {{$company->policy_category->name}}</td>
                    <td>
                        @if($company->active==1)
                    ...
                    <td class="text-right">
                        {{--<a href="{{route('admin.policy.show',['id'=>$company->id])}}" 
                        class="btn btn-info btn-xs" data-toggle="tooltip"
                           data-placement="top" title="View">
                            <i class="fa fa-eye"></i></a>--}}
                        <a href="{{route('admin.policy.delete',['id'=>$company->id])}}"
